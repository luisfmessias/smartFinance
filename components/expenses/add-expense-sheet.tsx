...
export function AddExpenseSheet({ open, onClose, onSave }: { open: boolean; onClose: () => void; onSave: (expense: Expense) => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-ink/40 backdrop-blur-sm">
      <section className="animate-in w-full max-w-md rounded-t-[28px] bg-white px-5 pb-8 pt-4 shadow-2xl">
        ...
        <header className="flex items-center justify-between">
          <div><h2 className="text-xl font-bold">Novo gasto</h2><p className="mt-1 text-xs text-slate-500">Registre em poucos segundos.</p></div>
